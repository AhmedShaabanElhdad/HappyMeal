...
public class OrderDBadapter {
    ...
    static final String DATABASE_TABLE = "foodorders";
    static final int DATABASE_VERSION = 1;


    static final String DATABASE_CREATE = "create table  if not exists foodorders (_id text not null,type text not null ,address text not null,date text not null,price text not null);";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper
    {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS foodorders");
            onCreate(db);
        }
    }
